...
class CompletedProjectsTab(QWidget):
    def __init__(self, db):
        ...
        # Temporary PDF path
        self.pdf_path = os.path.join(tempfile.gettempdir(), "Completed_Projects.pdf")
    ...
    def save_pdf(self):
        try:
            ...
            sheet.title = "Completed Projects"
            ...
            # Save Excel file
            excel_path = os.path.join(tempfile.gettempdir(), "Completed_Projects.xlsx")
